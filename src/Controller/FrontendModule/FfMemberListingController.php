...
namespace Skipman\ContaoFirefighterBundle\Controller\FrontendModule;
...
#[AsFrontendModule(category: 'firefighter_module', template: 'mod_ff_member_listing')]
class FfMemberListingController extends AbstractFrontendModuleController
{
    public const TYPE = 'ff_member_listing';
